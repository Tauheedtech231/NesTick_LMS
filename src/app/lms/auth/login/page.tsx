    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
          {/* Header Skeleton */}
          <div className="bg-gradient-to-r from-gray-300 to-gray-400 p-8">
            ...
            <div className="text-center">
              <div className="h-7 w-48 bg-gray-400 rounded mx-auto mb-2 animate-pulse"></div>
              <div className="h-4 w-64 bg-gray-400/80 rounded mx-auto animate-pulse"></div>
            </div>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mb-6">
              <div className="flex space-x-2">
                {[1, 2, 3].map((item) => (
                  <div key={item} className="flex-1 py-2 px-3 rounded-lg bg-gray-200 animate-pulse"></div>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <div className="h-4 w-32 bg-gray-300 rounded mb-1 animate-pulse"></div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
          ...
          <div className={`bg-gradient-to-r ${loginConfig.iconColor} p-8 text-white`}>
            <div className="flex items-center justify-center mb-4">
              <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold mb-2">{loginConfig.title}</h1>
              <p className="text-white/90 text-sm">{loginConfig.description}</p>
            </div>
          </div>
