  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-block border border-gray-300 rounded-lg px-8 py-6 bg-gray-50">
        ...
        <div 
          ref={contactRef}
          className="mt-16 text-center border-t border-gray-200 pt-10 opacity-0"
        >
          <div className="text-gray-600">
            <p className="mb-4">For more information about our programs and certifications</p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <div className="text-gray-900 font-medium">Call: <span className="text-[#6B21A8]">03224700200</span></div>
              <div className="text-gray-400 hidden sm:block">•</div>
              <div className="text-gray-900 font-medium">Email: <span className="text-[#6B21A8]">info@mansolhab.com</span></div>
            </div>
          </div>
        </div>
      </div>
