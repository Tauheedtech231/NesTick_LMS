    ...
    return (
      <div className="min-h-screen bg-white p-6">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium mb-2" style={{ color: BRAND_COLORS.darkGrey }}>No profile data found</h3>
          <p className="text-darkGrey/70">Please log in as an instructor to view profile.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-white rounded-lg border border-softGrey p-6">
            <div className="flex items-center gap-6 mb-8">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <h2 className="text-2xl font-bold text-darkGrey">{instructor.name}</h2>
                ...
                <p className="text-darkGrey/70">{instructor.specialization}</p>
                    ...
                    <div className="flex items-center gap-1">
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`w-4 h-4 ${i < Math.floor(instructor.rating) ? 'text-amber-400 fill-amber-400' : 'text-gray-300'}`}
                          />
                        ))}
                      </div>
                      <span className="text-sm font-medium text-darkGrey ml-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center"
                    ...
                    <Mail className="w-5 h-5" style={{ color: BRAND_COLORS.darkRoyalBlue }} />
                  </div>
                  <div>
                    <p className="text-sm text-darkGrey/70">Email Address</p>
                    <p className="font-medium text-darkGrey">{instructor.email}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center"
                    ...
                    <Phone className="w-5 h-5" style={{ color: BRAND_COLORS.teal }} />
                  </div>
                  <div>
                    <p className="text-sm text-darkGrey/70">Phone Number</p>
                    <p className="font-medium text-darkGrey">{instructor.phone}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: `${BRAND_COLORS.darkRoyalBlue}10` }}>
                    <Calendar className="w-5 h-5" style={{ color: BRAND_COLORS.darkRoyalBlue }} />
                  </div>
                  <div>
                    <p className="text-sm text-darkGrey/70">Member Since</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: `${BRAND_COLORS.teal}10` }}>
                    <Award className="w-5 h-5" style={{ color: BRAND_COLORS.teal }} />
                  </div>
                  <div>
                    <p className="text-sm text-darkGrey/70">Qualification</p>
                    <p className="font-medium text-darkGrey">{instructor.qualification}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: `${BRAND_COLORS.darkRoyalBlue}10` }}>
                    <Briefcase className="w-5 h-5" style={{ color: BRAND_COLORS.darkRoyalBlue }} />
                  </div>
                  <div>
                    <p className="text-sm text-darkGrey/70">Experience</p>
                    <p className="font-medium text-darkGrey">{instructor.experience}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: `${BRAND_COLORS.teal}10` }}>
                    <Book className="w-5 h-5" style={{ color: BRAND_COLORS.teal }} />
                  </div>
                  <div>
                    <p className="text-sm text-darkGrey/70">Specialization</p>
                    <p className="font-medium text-darkGrey">{instructor.specialization}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t border-softGrey">
              <div className="flex items-center gap-2 mb-4">
                <GraduationCap className="w-5 h-5" style={{ color: BRAND_COLORS.darkGrey }} />
                <h3 className="font-semibold text-darkGrey">Biography</h3>
              </div>
              <div className="bg-lightGrey rounded-lg p-4 border border-softGrey">
                <p className="text-darkGrey/80 whitespace-pre-line">
                  {instructor.bio}
                </p>
              </div>
            </div>
          ...
          {assignedCourse && (
            <div className="bg-white rounded-lg border border-softGrey p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-darkGrey">Assigned Course</h3>
                <div className="px-3 py-1 text-sm rounded-full bg-lightGrey text-darkGrey">
                  Primary Course
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium text-darkGrey mb-2">{assignedCourse.title}</h4>
                ...
                <div>
                  <h4 className="font-medium text-darkGrey mb-2">Course Description</h4>
                  ...
                  <div className="mt-4">
                    ...
                    {assignedCourse.originalPrice && (
                      <span className="text-sm line-through text-darkGrey/70 ml-2">
                        {assignedCourse.originalPrice}
                      </span>
                    )}
                  </div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: `${BRAND_COLORS.darkRoyalBlue}10` }}>
                    <Book className="w-4 h-4" style={{ color: BRAND_COLORS.darkRoyalBlue }} />
                  </div>
                  <span className="text-sm text-darkGrey">Assigned Course</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-darkGrey">Total Students</span>
                </div>
                <span className="font-medium text-darkNavy">{instructor.totalStudents}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: `${BRAND_COLORS.darkRoyalBlue}10` }}>
                    <Star className="w-4 h-4" style={{ color: BRAND_COLORS.darkRoyalBlue }} />
                  </div>
                  <span className="text-sm text-darkGrey">Rating</span>
                </div>
                <span className="font-medium text-darkNavy">{instructor.rating}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                    style={{ backgroundColor: `${BRAND_COLORS.teal}10` }}>
                    <Calendar className="w-4 h-4" style={{ color: BRAND_COLORS.teal }} />
                  </div>
                  <span className="text-sm text-darkGrey">Last Login</span>
                </div>
          ...
          <div className="bg-white rounded-lg border border-softGrey p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-darkGrey">Role</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-darkGrey">Account Status</span>
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                  instructor.status === 'active' 
                    ? 'text-white' 
                    : 'text-white'
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-darkGrey">Account Type</span>
                <span className={`px-3 py-1 text-xs font-medium rounded-full ${
                  instructor.isDemoAccount 
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-darkGrey">Instructor ID</span>
          ...
          {instructor.isDemoAccount && (
            <div className="bg-lightGrey rounded-lg p-4 border border-softGrey">
              <h4 className="font-medium text-darkGrey mb-2">Demo Account Notice</h4>
