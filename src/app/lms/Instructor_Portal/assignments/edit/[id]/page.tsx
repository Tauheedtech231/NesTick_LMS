// app/lms/Instructor_Portal/assignments/edit/[id]/page.tsx
'use client'
...
export default function EditAssignmentPage() {
  ...
  const loadData = () => {
    try {
      ...
      setFormData({
        ...
        totalMarks: foundAssignment.totalMarks,
        dueDate: new Date(foundAssignment.dueDate).toISOString().slice(0, 16),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedAssignments = allAssignments.map((a: Assignment) => {
      ...
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white border border-gray-300 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">The assignment you're trying to edit doesn't exist.</p>
            <Link
