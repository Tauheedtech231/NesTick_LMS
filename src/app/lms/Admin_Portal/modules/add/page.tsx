...
export default function AddModule() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    localStorage.setItem('modules', JSON.stringify([...existingModules, newModule]))
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Add New Module</h1>
          <p className="text-gray-600 mt-2">Create a new learning module for a course</p>
        </div>
      </div>
